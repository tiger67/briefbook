<template>
  <div class='cmt-line'>
    <div class="author">
      <router-link to="/myCenter" class="avatar"><img :src="user.avatar" alt=""></router-link>
      <div class="info">
        <router-link to="/myCenter" class="name">毛毛的蛇</router-link>
        <div class="meta">{{mindex+1}}楼 · 2018-10-22</div>
      </div>
    </div>
    <p class="cmt-content">
      过早是什么意思?
    ...
    <div class="tool-group">
      <a href="javascript:void(0);" class="cmt-tool-zang" :class="{'zan-animation':zan,'active':cmt.isZan}" v-signin="{path:()=>{ console.log('dsdsdjsjdsj')  }}">
