<template>
  <div class="sign-form sign-in">
    <form>
      <!--  v-error="nickname.error" v-error="nickname.error" -->
      <div class="input-box">
        <input type="text" placeholder="手机号/邮箱" v-error="'empty,mobile,:手机号'" v-model="nickname">
      ...
      <router-link to="/forget_password" class="problem">忘记密码</router-link>
